...
2. **NIEMALS** Code ändern ohne Spec-File (`specs/TT-XXX.md`)
...
- **spec-gate.sh**: Blockiert Commits mit Issue-Referenz wenn `specs/TT-XXX.md` fehlt oder `## Agent-Pattern` nicht ausgefüllt ist
...
Entscheidung in `specs/TT-XXX.md` unter `## Agent-Pattern` eintragen — wird von spec-gate.sh erzwungen.
