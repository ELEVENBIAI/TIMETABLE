...
import { scheduleGeneratorRoutes } from './routes/schedule-generator.js';
...
import { templateEntryRoutes } from './routes/template-entries.js';
...
export async function buildApp() {
  ...
  await fastify.register(scheduleTemplateRoutes);
  await fastify.register(templateEntryRoutes);
  ...
  await fastify.register(scheduleGeneratorRoutes);
  await fastify.register(dsgvoRoutes);
